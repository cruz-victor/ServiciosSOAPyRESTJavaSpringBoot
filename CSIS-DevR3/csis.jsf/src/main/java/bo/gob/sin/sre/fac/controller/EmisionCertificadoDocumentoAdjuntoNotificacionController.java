...
import bo.gob.sin.sap.cead.componentes.controller.DocumentoAdjuntoNotificacionAbstract;
import bo.gob.sin.sre.fac.model.ContextoSolicitudCertificacionSistemaModel;

@SuppressWarnings("deprecation")
@ViewScoped
@ManagedBean(name = "emisionDocumentoAdjuntoNotificacionController")
public class EmisionCertificadoDocumentoAdjuntoNotificacionController extends DocumentoAdjuntoNotificacionAbstract implements Serializable {
	...
	public void cargarDatos(long idTramite) {
		this.getListaDocumentosAdjuntosNotificacion().cargarDocumentoNotificablesTramite(idTramite);
	}
}
