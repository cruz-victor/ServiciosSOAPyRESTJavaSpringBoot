...
/**
 * Objetivo: Entidad para la factura de ventas para sectores educativos.
 * Creado por: Peter Flores.
 * Fecha: 20/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_colegios", schema = "SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasColegios.findAll", query="SELECT s FROM SreFacVentasColegios s")
public class SreFacVentasColegios implements Serializable {
	...
	@Column(name="recepcion_correcta_colegio_id")
	...
	//bi-directional many-to-one association to SreFacDetallesVentasColegio
	@OneToMany(mappedBy="sreFacVentasColegios")
	private List<SreFacDetallesVentasColegios> sreFacDetallesVentasColegios;

	public SreFacVentasColegios() {
	}
	...
	public Long getRecepcionCorrectaColegioId() {
		return this.recepcionCorrectaColegioId;
	}
	...
	public List<SreFacDetallesVentasColegios> getSreFacDetallesVentasColegios() {
		return this.sreFacDetallesVentasColegios;
	}

	public void setSreFacDetallesVentasColegios(List<SreFacDetallesVentasColegios> sreFacDetallesVentasColegios) {
		this.sreFacDetallesVentasColegios = sreFacDetallesVentasColegios;
	}

	public SreFacDetallesVentasColegios addSreFacDetallesVentasColegio(SreFacDetallesVentasColegios sreFacDetallesVentasColegio) {
		getSreFacDetallesVentasColegios().add(sreFacDetallesVentasColegio);
		sreFacDetallesVentasColegio.setSreFacVentasColegios(this);

		return sreFacDetallesVentasColegio;
	}

	public SreFacDetallesVentasColegios removeSreFacDetallesVentasColegio(SreFacDetallesVentasColegios sreFacDetallesVentasColegio) {
		getSreFacDetallesVentasColegios().remove(sreFacDetallesVentasColegio);
		sreFacDetallesVentasColegio.setSreFacVentasColegios(null);
