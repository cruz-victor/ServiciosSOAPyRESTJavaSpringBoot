...
/**
 * Objetivo: Entidad para la factura de ventas para Alquileres.
 * Creado por: Peter Flores.
 * Fecha: 24/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_alquileres", schema="SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasAlquileres.findAll", query="SELECT s FROM SreFacVentasAlquileres s")
public class SreFacVentasAlquileres implements Serializable {
	...
	@Column(name="recepcion_correcta_alquiler_id")
	...
	public Long getRecepcionCorrectaAlquilerId() {
		return this.recepcionCorrectaAlquilerId;
	}
