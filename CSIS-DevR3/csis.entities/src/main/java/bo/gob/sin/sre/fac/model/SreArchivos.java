...
@Entity
@Table(name = "SRE_FAC_ARCHIVOS", schema="SRE_RECAUDACIONES")
public class SreArchivos implements Serializable {
	...
	public SreArchivos(Long archivoId, byte[] archivo, String estadoId) {
