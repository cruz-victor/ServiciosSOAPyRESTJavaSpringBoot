...
/**
 * Objetivo: Entidad para la factura de ventas para Embotelladoras.
 * Creado por: Peter Flores.
 * Fecha: 24/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_embotelladoras", schema="SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasEmbotelladoras.findAll", query="SELECT s FROM SreFacVentasEmbotelladoras s")
public class SreFacVentasEmbotelladoras implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="venta_embotelladora_id")
	...
	@Column(name="recepcion_correcta_embotelladora_id")
	...
	//bi-directional many-to-one association to SreFacDetallesVentasEmbotelladoras
	@OneToMany(mappedBy="sreFacVentasEmbotelladoras")
	private List<SreFacDetallesVentasEmbotelladoras> SreFacDetallesVentasEmbotelladoras;

	public SreFacVentasEmbotelladoras() {
	}

	public Long getVentaEmbotelladoraId() {
		return this.ventaEmbotelladoraId;
	}
	...
	public Long getRecepcionCorrectaEmbotelladoraId() {
		return this.recepcionCorrectaEmbotelladoraId;
	}
	...
	public List<SreFacDetallesVentasEmbotelladoras> getSreFacDetallesVentasEmbotelladoras() {
		return this.SreFacDetallesVentasEmbotelladoras;
	}

	public void setSreFacDetallesVentasEmbotelladoras(List<SreFacDetallesVentasEmbotelladoras> SreFacDetallesVentasEmbotelladoras) {
		this.SreFacDetallesVentasEmbotelladoras = SreFacDetallesVentasEmbotelladoras;
	}

	public SreFacDetallesVentasEmbotelladoras addSreFacDetallesVentasEmbotelladoras(SreFacDetallesVentasEmbotelladoras SreFacDetallesVentasEmbotelladoras) {
		getSreFacDetallesVentasEmbotelladoras().add(SreFacDetallesVentasEmbotelladoras);
		SreFacDetallesVentasEmbotelladoras.setSreFacVentasEmbotelladoras(this);

		return SreFacDetallesVentasEmbotelladoras;
	}

	public SreFacDetallesVentasEmbotelladoras removeSreFacDetallesVentasEmbotelladoras(SreFacDetallesVentasEmbotelladoras SreFacDetallesVentasEmbotelladoras) {
		getSreFacDetallesVentasEmbotelladoras().remove(SreFacDetallesVentasEmbotelladoras);
		SreFacDetallesVentasEmbotelladoras.setSreFacVentasEmbotelladoras(null);
