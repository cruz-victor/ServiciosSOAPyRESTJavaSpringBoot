...
/**
 * Objetivo: Entidad para la factura de ventas para Juegos del Azar.
 * Creado por: Peter Flores.
 * Fecha: 24/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_juegos", schema="SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasJuegos.findAll", query="SELECT s FROM SreFacVentasJuegos s")
public class SreFacVentasJuegos implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="venta_juego_id")
	...
	@Column(name="recepcion_correcta_juego_id")
	...
	public SreFacVentasJuegos() {
	}

	public Long getVentaJuegoId() {
		return this.ventaJuegoId;
	}
	...
	public BigDecimal getMontoTotalSujetoIpj() {
		return this.montoTotalSujetoIpj;
	}
	...
	public Long getRecepcionCorrectaJuegoId() {
		return this.recepcionCorrectaJuegoId;
	}
