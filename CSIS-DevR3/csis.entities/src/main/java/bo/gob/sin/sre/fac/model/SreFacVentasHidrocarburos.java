...
/**
 * Objetivo: Entidad para la factura de ventas para la comercialización de hidrocarburos.
 * Creado por: Peter Flores.
 * Fecha: 21/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_hidrocarburos", schema = "SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasHidrocarburos.findAll", query="SELECT s FROM SreFacVentasHidrocarburos s")
public class SreFacVentasHidrocarburos implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="venta_hidrocarburo_id")
	...
	@Column(name="recepcion_correcta_hidrocarburo_id")
	...
	//bi-directional many-to-one association to SreFacDetallesVentasHidrocarburo
	@OneToMany(mappedBy="sreFacVentasHidrocarburos")
	private List<SreFacDetallesVentasHidrocarburos> sreFacDetallesVentasHidrocarburos;

	public SreFacVentasHidrocarburos() {
	}

	public Long getVentaHidrocarburoId() {
		return this.ventaHidrocarburoId;
	}
	...
	public Long getRecepcionCorrectaHidrocarburoId() {
		return this.recepcionCorrectaHidrocarburoId;
	}
	...
	public List<SreFacDetallesVentasHidrocarburos> getSreFacDetallesVentasHidrocarburos() {
		return this.sreFacDetallesVentasHidrocarburos;
	}

	public void setSreFacDetallesVentasHidrocarburos(List<SreFacDetallesVentasHidrocarburos> sreFacDetallesVentasHidrocarburos) {
		this.sreFacDetallesVentasHidrocarburos = sreFacDetallesVentasHidrocarburos;
	}

	public SreFacDetallesVentasHidrocarburos addSreFacDetallesVentasHidrocarburos(SreFacDetallesVentasHidrocarburos sreFacDetallesVentasHidrocarburos) {
		getSreFacDetallesVentasHidrocarburos().add(sreFacDetallesVentasHidrocarburos);
		sreFacDetallesVentasHidrocarburos.setSreFacVentasHidrocarburos(this);
		return sreFacDetallesVentasHidrocarburos;
	}

	public SreFacDetallesVentasHidrocarburos removeSreFacDetallesVentasHidrocarburos(SreFacDetallesVentasHidrocarburos sreFacDetallesVentasHidrocarburos) {
		getSreFacDetallesVentasHidrocarburos().remove(sreFacDetallesVentasHidrocarburos);
		sreFacDetallesVentasHidrocarburos.setSreFacVentasHidrocarburos(null);
		return sreFacDetallesVentasHidrocarburos;
	}
