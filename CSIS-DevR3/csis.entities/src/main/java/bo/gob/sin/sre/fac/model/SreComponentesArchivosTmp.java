...
@Entity
@Table(name="sre_fac_componentes_archivos_tmp", schema="SRE_RECAUDACIONES")
@NamedQuery(name="SreComponentesArchivosTmp.findAll", query="SELECT s FROM SreComponentesArchivosTmp s")
public class SreComponentesArchivosTmp implements Serializable {
	...
	public SreComponentesArchivosTmp() {
	}
