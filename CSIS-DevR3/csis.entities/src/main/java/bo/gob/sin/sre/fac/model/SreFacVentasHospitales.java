...
/**
 * Objetivo: Entidad para la factura de ventas para Hospitales/Clínicas.
 * Creado por: Peter Flores.
 * Fecha: 24/12/2018
 */
@Entity
@Table(name="sre_fac_ventas_hospitales", schema="SRE_RECAUDACIONES")
@NamedQuery(name="SreFacVentasHospitales.findAll", query="SELECT s FROM SreFacVentasHospitales s")
public class SreFacVentasHospitales implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="venta_hospital_id")
	...
	@Column(name="recepcion_correcta_hospital_id")
	...
	public SreFacVentasHospitales() {
	}

	public Long getVentaHospitalId() {
		return this.ventaHospitalId;
	}
	...
	public Long getRecepcionCorrectaHospitalId() {
		return this.recepcionCorrectaHospitalId;
	}
