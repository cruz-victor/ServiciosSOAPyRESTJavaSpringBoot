...
public class RegistroObservacionesComponentesDto implements Serializable {
	...
	public RegistroObservacionesComponentesDto() {
		super();
	}

	public RegistroObservacionesComponentesDto(long registroPruebaAutomaticaId, long usuarioRegistroId,
