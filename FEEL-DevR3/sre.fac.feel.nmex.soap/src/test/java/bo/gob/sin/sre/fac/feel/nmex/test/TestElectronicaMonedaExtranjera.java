package bo.gob.sin.sre.fac.feel.nmex.test;
...
import bo.gob.sin.sre.fac.feel.nmex.service.IServicioNotaFiscalElectronicaCompraVentaMonedaExtranjera;

public class TestElectronicaMonedaExtranjera {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaCompraVentaMonedaExtranjera servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaCompraVentaMonedaExtranjera.class);
