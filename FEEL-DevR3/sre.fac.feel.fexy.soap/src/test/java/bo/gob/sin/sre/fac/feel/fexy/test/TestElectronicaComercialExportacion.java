package bo.gob.sin.sre.fac.feel.fexy.test;
...
import bo.gob.sin.sre.fac.feel.fexy.service.IServicioFacturaElectronicaComercialExportacionYPFB;


public class TestElectronicaComercialExportacion {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39225/FacturaElectronicaComercialExportacionYPFB?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaComercialExportacionYPFB";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaComercialExportacionYPFB servicio = servicioSoap.getPort(IServicioFacturaElectronicaComercialExportacionYPFB.class);
		...
		solicitud.setCodigoDocumentoSector(12);
