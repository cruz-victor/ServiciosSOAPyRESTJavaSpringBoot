package bo.gob.sin.sre.fac.feel.nzfr.test;
...
import bo.gob.sin.sre.fac.feel.nzfr.service.IServicioNotaFiscalElectronicaZonaFranca;

public class TestElectronicaZonaFranca {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaZonaFranca servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaZonaFranca.class);
