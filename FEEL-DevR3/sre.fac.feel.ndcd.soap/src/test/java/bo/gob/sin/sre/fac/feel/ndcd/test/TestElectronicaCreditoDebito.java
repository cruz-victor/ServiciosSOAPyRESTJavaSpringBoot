package bo.gob.sin.sre.fac.feel.ndcd.test;
...
import bo.gob.sin.sre.fac.feel.ndcd.service.IServicioNotaFiscalElectronicaCreditoDebito;


public class TestElectronicaCreditoDebito {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39125/NotaFiscalElectronicaCreditoDebito?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/NotaFiscalElectronicaCreditoDebito";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaCreditoDebito servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaCreditoDebito.class);
		...
		solicitud.setCodigoDocumentoSector(18);
