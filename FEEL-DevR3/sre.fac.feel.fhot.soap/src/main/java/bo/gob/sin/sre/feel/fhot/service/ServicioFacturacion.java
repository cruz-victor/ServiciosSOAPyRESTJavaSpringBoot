...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaHotel")
public class ServicioFacturacion implements IServicioFacturaElectronicadaHotel {
