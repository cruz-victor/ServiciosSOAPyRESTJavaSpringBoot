package bo.gob.sin.sre.feel.ffin.service;
...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaEntidadFinanciera")
public class ServicioFacturacion implements IServicioFacturaElectronicaEntidadFinanciera {
