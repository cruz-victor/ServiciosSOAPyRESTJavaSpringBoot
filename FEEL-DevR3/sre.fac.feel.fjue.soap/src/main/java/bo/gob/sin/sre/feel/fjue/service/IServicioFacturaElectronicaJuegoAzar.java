...
public interface IServicioFacturaElectronicaJuegoAzar {

	@WebMethod(operationName = "verificarComunicacion")
	public int verificarConexion();

	@WebMethod(operationName = "recepcionFacturaElectronicaJuegoAzar")
	...
	@WebMethod(operationName = "recepcionPaqueteFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPaqueteFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "anulacionFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionAnulacionFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "recepcionMasivaFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionMasivaFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionMasiva(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionPorCufFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "obtenerRecepcionAnulacionFacturaElectronicaJuegoAzar")
	@WebResult(name = "RespuestaServicioFacturacion")
