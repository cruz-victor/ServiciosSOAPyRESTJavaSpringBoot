package bo.gob.sin.sre.feel.fjue.service;
...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaJuegoAzar")
public class ServicioFacturacion implements IServicioFacturaElectronicaJuegoAzar {
