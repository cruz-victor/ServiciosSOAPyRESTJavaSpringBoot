...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaArtistaInternacional")
public class ServicioFacturacion implements IServicioFacturaElectronicadaArtistaInternacional {
