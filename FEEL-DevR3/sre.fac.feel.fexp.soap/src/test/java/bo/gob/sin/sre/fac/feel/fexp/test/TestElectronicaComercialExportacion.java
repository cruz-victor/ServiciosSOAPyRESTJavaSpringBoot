package bo.gob.sin.sre.fac.feel.fexp.test;
...
import bo.gob.sin.sre.fac.feel.fexp.service.IServicioFacturaElectronicaComercialExportacion;


public class TestElectronicaComercialExportacion {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39124/FacturaElectronicaComercialExportacion?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaComercialExportacion";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaComercialExportacion servicio = servicioSoap.getPort(IServicioFacturaElectronicaComercialExportacion.class);
