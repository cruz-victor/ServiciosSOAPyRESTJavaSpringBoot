package bo.gob.sin.sre.fac.feel.fvim.test;
...
import bo.gob.sin.sre.fac.feel.fvim.service.IServicioFacturaElectronicaVentaInternaMinera;

public class TestElectronicaVentaInternaMinera {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39230/FacturaElectronicaVentaInternaMinera?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaVentaInternaMinera";
	...
	public void recepcionIndivual() throws Exception {
		...
		IServicioFacturaElectronicaVentaInternaMinera servicio = servicioSoap
				.getPort(IServicioFacturaElectronicaVentaInternaMinera.class);
