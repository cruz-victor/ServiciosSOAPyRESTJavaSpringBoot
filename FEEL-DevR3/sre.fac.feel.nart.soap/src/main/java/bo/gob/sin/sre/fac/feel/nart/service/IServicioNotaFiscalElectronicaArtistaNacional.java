...
public interface IServicioNotaFiscalElectronicaArtistaNacional {

	@WebMethod(operationName = "verificarComunicacion")
	public int verificarConexion();

	@WebMethod(operationName = "recepcionNotaFiscalElectronicaArtistaNacional")
	...
	@WebMethod(operationName = "recepcionPaqueteNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPaqueteNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "anulacionNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionAnulacionNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "recepcionMasivaNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionMasivaNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionMasiva(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionPorCufNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "obtenerRecepcionAnulacionNotaFiscalElectronicaArtistaNacional")
	@WebResult(name = "RespuestaServicioFacturacion")
