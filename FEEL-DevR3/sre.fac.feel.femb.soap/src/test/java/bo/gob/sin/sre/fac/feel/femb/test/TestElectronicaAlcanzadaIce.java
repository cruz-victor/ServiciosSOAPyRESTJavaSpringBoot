package bo.gob.sin.sre.fac.feel.femb.test;
...
import bo.gob.sin.sre.fac.feel.femb.service.IServicioFacturaElectronicaEmpresaAlcanzadaIce;

public class TestElectronicaAlcanzadaIce {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaEmpresaAlcanzadaIce servicio = servicioSoap.getPort(IServicioFacturaElectronicaEmpresaAlcanzadaIce.class);
