package bo.gob.sin.sre.fac.fcel.ncon.test;
...
import bo.gob.sin.sre.fac.feel.ncon.service.IServicioNotaFiscalElectronicaConciliacion;


public class TestElectronicaConciliacion {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39207/NotaFiscalElectronicaConciliacion?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/NotaFiscalElectronicaConciliacion";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaConciliacion servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaConciliacion.class);
		...
		solicitud.setCodigoDocumentoSector(19);
