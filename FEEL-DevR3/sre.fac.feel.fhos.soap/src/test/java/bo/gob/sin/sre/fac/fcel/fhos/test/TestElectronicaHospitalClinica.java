package bo.gob.sin.sre.fac.fcel.fhos.test;
...
import bo.gob.sin.sre.fac.feel.fhos.service.IServicioFacturaElectronicaHospitalClinica;


public class TestElectronicaHospitalClinica {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39180/FacturaElectronicaHospitalClinica?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaHospitalClinica";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaHospitalClinica servicio = servicioSoap.getPort(IServicioFacturaElectronicaHospitalClinica.class);
		...
		solicitud.setCodigoDocumentoSector(9);
