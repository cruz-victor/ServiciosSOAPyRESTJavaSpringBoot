...
public interface IServicioNotaFiscalElectronicaCreditoDebitoSfv {

	@WebMethod(operationName = "verificarComunicacion")
	public int verificarConexion();

	@WebMethod(operationName = "recepcionNotaFiscalElectronicaCreditoDebitoSfv")
	...
	@WebMethod(operationName = "recepcionPaqueteNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPaqueteNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "anulacionNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionAnulacionNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPorCufNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "obtenerRecepcionAnulacionNotaFiscalElectronicaCreditoDebitoSfv")
	@WebResult(name = "RespuestaServicioFacturacion")
