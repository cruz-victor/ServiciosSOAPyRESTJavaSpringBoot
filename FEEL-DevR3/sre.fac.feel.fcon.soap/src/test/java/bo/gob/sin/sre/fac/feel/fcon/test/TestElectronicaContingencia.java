package bo.gob.sin.sre.fac.feel.fcon.test;
...
import bo.gob.sin.sre.fac.cfec.dto.fcon.interfaces.SolicitudAnulacion;
import bo.gob.sin.sre.fac.cfec.dto.fcon.interfaces.SolicitudValidacionAnulacion;
...
import bo.gob.sin.sre.fac.feel.fcon.service.IServicioFacturaElectronicaContingencia;

public class TestElectronicaContingencia {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39131/FacturaElectronicaContingencia?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaContingencia";
	...
	public void recepcionPaquete() throws Exception {
		...
		IServicioFacturaElectronicaContingencia servicio = servicioSoap
				.getPort(IServicioFacturaElectronicaContingencia.class);
