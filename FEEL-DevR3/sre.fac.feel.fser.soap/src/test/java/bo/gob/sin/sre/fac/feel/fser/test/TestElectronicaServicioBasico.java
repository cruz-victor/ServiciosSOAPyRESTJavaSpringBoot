package bo.gob.sin.sre.fac.feel.fser.test;
...
import bo.gob.sin.sre.fac.feel.fser.service.IServicioFacturaElectronicaServicioBasico;


public class TestElectronicaServicioBasico {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39172/FacturaElectronicaServicioBasico?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaServicioBasico";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaServicioBasico servicio = servicioSoap.getPort(IServicioFacturaElectronicaServicioBasico.class);
		...
		solicitud.setCodigoDocumentoSector(5);
