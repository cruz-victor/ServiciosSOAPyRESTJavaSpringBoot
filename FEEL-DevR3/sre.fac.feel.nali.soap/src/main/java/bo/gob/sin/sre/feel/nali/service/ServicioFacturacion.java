...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/NotaFiscalElectronicaSeguridadAlimentaria")
public class ServicioFacturacion implements IServicioNotaFiscalElectronicaSeguridadAlimentaria {
	...
	@Override
	public IRespuesta recepcion(ISolicitudRecepcionNali solicitud) {
		...
		try {
			...
			vArchivoXml.setP_codigoAutorizacionAlimentaria(solicitud.getCodigoAutorizacion());
	...
	@Override
	public IRespuesta recepcionPaquete(ISolicitudRecepcionNali solicitud) {
		XmlRecepcionGenericoDto vArchivoXml = new XmlRecepcionGenericoDto();
	...
	@Override
	public IRespuesta recepcionMasiva(ISolicitudRecepcionNali solicitud) {
		XmlRecepcionGenericoDto vArchivoXml = new XmlRecepcionGenericoDto();
