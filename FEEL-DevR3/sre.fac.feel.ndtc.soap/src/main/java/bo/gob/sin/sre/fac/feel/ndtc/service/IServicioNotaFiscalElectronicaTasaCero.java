package bo.gob.sin.sre.fac.feel.ndtc.service;
...
public interface IServicioNotaFiscalElectronicaTasaCero {

	@WebMethod(operationName = "verificarComunicacion")
	public int verificarConexion();

	@WebMethod(operationName = "recepcionNotaFiscalElectronicaTasaCero")
	...
	@WebMethod(operationName = "recepcionPaqueteNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPaqueteNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "anulacionNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionAnulacionNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "recepcionMasivaNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionMasivaNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionMasiva(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionPorCufNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "obtenerRecepcionAnulacionNotaFiscalElectronicaTasaCero")
	@WebResult(name = "RespuestaServicioFacturacion")
