package bo.gob.sin.sre.fac.feel.ndtc.test;
...
import bo.gob.sin.sre.fac.feel.ndtc.service.IServicioNotaFiscalElectronicaTasaCero;

public class TestElectronicaTasaCero {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaTasaCero servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaTasaCero.class);
