package bo.gob.sin.sre.fac.fee.fhid.service;
...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaHidrocarburo")
public class ServicioFacturacion implements IServicioFacturaElectronicaHidrocarburo {
