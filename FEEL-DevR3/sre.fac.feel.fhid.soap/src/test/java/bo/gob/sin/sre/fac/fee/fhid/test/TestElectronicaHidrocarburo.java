package bo.gob.sin.sre.fac.fee.fhid.test;
...
import bo.gob.sin.sre.fac.fee.fhid.service.IServicioFacturaElectronicaHidrocarburo;


public class TestElectronicaHidrocarburo {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaHidrocarburo servicio = servicioSoap.getPort(IServicioFacturaElectronicaHidrocarburo.class);
