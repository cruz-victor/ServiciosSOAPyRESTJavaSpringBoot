package bo.gob.sin.sre.fac.feel.fpre.test;
...
import bo.gob.sin.sre.fac.cfec.dto.fpre.interfaces.SolicitudAnulacion;
import bo.gob.sin.sre.fac.cfec.dto.fpre.interfaces.SolicitudRecepcion;
import bo.gob.sin.sre.fac.cfec.dto.fpre.interfaces.SolicitudValidacionAnulacion;
import bo.gob.sin.sre.fac.cfec.dto.fpre.interfaces.SolicitudValidacionRecepcion;
import bo.gob.sin.sre.fac.feel.fpre.service.IServicioFacturaElectronicaPrevalorada;


public class TestElectronicaPrevalorada {

	public static final String NOMBRE_SERVICIO = "ServicioFacturacionService";
	public static final String URL = "http://localhost:39212/FacturaElectronicaPrevalorada?wsdl";
	public static final String TARGET_NAME_SPACE = "https://siat.impuestos.gob.bo/FacturaElectronicaPrevalorada";
	/*
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioFacturaElectronicaPrevalorada servicio = servicioSoap.getPort(IServicioFacturaElectronicaPrevalorada.class);
		...
		solicitud.setCodigoModalidad(5);
