...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/FacturaElectronicaAlquilerBienInmueble")
public class ServicioFacturacion implements IServicioFacturaElectronicaAlquilerBienInmueble {
