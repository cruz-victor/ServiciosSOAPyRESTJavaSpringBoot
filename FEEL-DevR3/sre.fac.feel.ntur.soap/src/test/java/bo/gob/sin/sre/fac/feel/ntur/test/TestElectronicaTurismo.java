package bo.gob.sin.sre.fac.feel.ntur.test;
...
import bo.gob.sin.sre.fac.feel.ntur.service.IServicioNotaFiscalElectronicaServicioTuristicoHospedaje;

public class TestElectronicaTurismo {
	...
	public void recepcionIndivual() throws Exception{
		...
		IServicioNotaFiscalElectronicaServicioTuristicoHospedaje servicio = servicioSoap.getPort(IServicioNotaFiscalElectronicaServicioTuristicoHospedaje.class);
