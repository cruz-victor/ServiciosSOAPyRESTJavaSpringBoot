package bo.gob.sin.sre.feel.nexl.service;
...
@Service
@WebService(targetNamespace = "https://siat.impuestos.gob.bo/NotaFiscalElectronicaLibreConsignacion")
public class ServicioFacturacion implements IServicioNotaFiscalElectronicaLibreConsignacion {
