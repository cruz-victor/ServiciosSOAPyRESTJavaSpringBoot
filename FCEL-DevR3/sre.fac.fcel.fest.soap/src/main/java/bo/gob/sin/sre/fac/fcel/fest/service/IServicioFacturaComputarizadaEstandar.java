...
public interface IServicioFacturaComputarizadaEstandar {

	@WebMethod(operationName = "verificarComunicacion")
	public int verificarConexion();

	@WebMethod(operationName = "recepcionFacturaComputarizadaEstandar")
	...
	@WebMethod(operationName = "recepcionPaqueteFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionRecepcionPaqueteFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionPaquete(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "anulacionFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "validacionAnulacionFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "recepcionMasivaFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta recepcionMasiva(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioRecepcion") ISolicitudRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionMasivaFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	public IRespuesta validacionRecepcionMasiva(
			@XmlElement(required = true) @WebParam(name = "SolicitudServicioValidacionRecepcion") ISolicitudValidacionRecepcion solicitud);

	@WebMethod(operationName = "validacionRecepcionPorCufFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
	...
	@WebMethod(operationName = "obtenerRecepcionAnulacionFacturaComputarizadaEstandar")
	@WebResult(name = "RespuestaServicioFacturacion")
...
//	@WebMethod(operationName = "obtenerRecepcionAnulacionFacturaComputarizadaEstandar")
//	@WebResult(name = "RespuestaServicioFacturacion")
//	public IRespuesta obtenerRecepcionAnulacionPorCuf(
//			@XmlElement(required = true) @WebParam(name = "SolicitudServicioConsultaAnulacionPorCuf") ISolicitudValidacionRecepcionPorCuf solicitud);
