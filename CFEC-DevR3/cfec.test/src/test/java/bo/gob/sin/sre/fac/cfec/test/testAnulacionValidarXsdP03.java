...
@Transactional
@Rollback 
public class testAnulacionValidarXsdP03 {
	private static final Logger LOG = LoggerFactory.getLogger(testAnulacionValidarXsdP03.class);
	...
	@Rollback(false)
	@Test
	public void validarAnulacionXsdP03() throws Exception{
