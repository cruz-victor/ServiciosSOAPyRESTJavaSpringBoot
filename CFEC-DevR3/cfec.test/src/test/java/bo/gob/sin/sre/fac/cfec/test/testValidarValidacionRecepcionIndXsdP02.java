...
@Transactional
@Rollback 
public class testValidarValidacionRecepcionIndXsdP02 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarValidacionRecepcionIndXsdP02.class);
	...
	@Rollback(false)
	@Test
	public void validarValidacionRecepcionIndXsdP02() throws Exception{
