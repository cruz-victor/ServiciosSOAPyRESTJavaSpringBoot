...
public class TestComputarizadaEstandar {
	...
	@Rollback(false)
	@Test
	public void TestRecepcionIndivualP011() throws Exception{
		// computarizada OK
		...
		try {
			//***            
			vArchivoXml.setP_codigo_sistema("JUANITO");
...
//			vArchivoXml.setV_hash_archivo("02f0836fccc44af6b75f7b8e3a1a56548427d4dc92517628d6bfbb4ea962b89d");
			RespuestaListaRegistroRecepcionesSoapDto vRespuestaDto = iCoreFacturacionSoap.CoreFacturacionPrincipal(vArchivoXml, Parametros.Anulacion);
