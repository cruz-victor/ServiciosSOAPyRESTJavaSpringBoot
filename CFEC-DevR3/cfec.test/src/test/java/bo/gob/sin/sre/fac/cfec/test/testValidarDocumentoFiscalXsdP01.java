...
@Transactional
@Rollback 
public class testValidarDocumentoFiscalXsdP01 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarDocumentoFiscalXsdP01.class);
	...
	@Rollback(false)
	@Test
	public void validarDocumentoFiscalXsdP01() throws Exception{
