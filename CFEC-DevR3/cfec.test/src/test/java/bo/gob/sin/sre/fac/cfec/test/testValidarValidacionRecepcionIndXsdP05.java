...
@Transactional
@Rollback 
public class testValidarValidacionRecepcionIndXsdP05 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarValidacionRecepcionIndXsdP05.class);
	...
	@Rollback(false)
	@Test
	public void validarValidacionRecepcionIndXsdP05() throws Exception{
