...
@Transactional
@Rollback
public class TestPortalWebValidacionRecepcionIndividual {
	private static final Logger LOG = LoggerFactory.getLogger(TestPortalWebValidacionRecepcionIndividual.class);
	...
	@Rollback(false)
	@Test
	public void validacionRecepcionFacturaPortalWeb01() throws Exception {
		RespuestaJsonDto vRespuesta = new RespuestaJsonDto();
		try {
			LOG.info("validacionRecepcionFacturaPortalWeb01 ==>" + vRespuesta.toString());
			...
			solicitud.setCodigoRecepcion(12345L);
			...
			vXmlRecGenDto.setV_recepcionId(solicitud.getCodigoRecepcion());

			vRespuesta = iServiciosClientRest.validacionRecepcionFacturaPortalWeb(vXmlRecGenDto);
