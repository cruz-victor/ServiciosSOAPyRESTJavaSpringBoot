...
@Transactional
@Rollback 
public class testValidarRecepcionIndividualXsdP04 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarRecepcionIndividualXsdP04.class);
	...
	@Rollback(false)
	@Test
	public void validarRecepcionIndividualXsdP04() throws Exception{
