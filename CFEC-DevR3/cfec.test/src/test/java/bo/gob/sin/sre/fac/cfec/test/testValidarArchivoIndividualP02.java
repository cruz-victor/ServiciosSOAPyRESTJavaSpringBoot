...
@Transactional
@Rollback 
public class testValidarArchivoIndividualP02 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarArchivoIndividualP02.class);
	...
	@Rollback(false)
	@Test
	public void validarArchivoIndividualP02() throws Exception{
