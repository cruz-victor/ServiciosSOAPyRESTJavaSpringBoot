...
@Transactional
@Rollback 
public class testValidarValidacionRecepcionIndXsdP01 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarValidacionRecepcionIndXsdP01.class);
	...
	@Rollback(false)
	@Test
	public void validarValidacionRecepcionIndXsdP01() throws Exception{
