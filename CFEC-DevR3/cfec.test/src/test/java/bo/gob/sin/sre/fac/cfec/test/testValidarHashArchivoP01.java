...
@Transactional
@Rollback 
public class testValidarHashArchivoP01 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarHashArchivoP01.class);
	...
	@Rollback(false)
	@Test
	public void validarHashArchivoP01() throws Exception{
