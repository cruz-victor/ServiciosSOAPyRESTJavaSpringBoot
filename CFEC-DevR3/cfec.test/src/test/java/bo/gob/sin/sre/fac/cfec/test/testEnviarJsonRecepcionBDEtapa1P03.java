...
@Transactional
@Rollback 
public class testEnviarJsonRecepcionBDEtapa1P03 {
	private static final Logger LOG = LoggerFactory.getLogger(testEnviarJsonRecepcionBDEtapa1P03.class);
	...
	@Rollback(false)
	@Test
	public void enviarJsonRecepcionBDEtapa1P03() throws Exception{
