...
@Transactional
@Rollback 
public class testEnviarJsonRecepcionBDEtapa1P04 {
	private static final Logger LOG = LoggerFactory.getLogger(testEnviarJsonRecepcionBDEtapa1P04.class);
	...
	@Rollback(false)
	@Test
	public void enviarJsonRecepcionBDEtapa1P04() throws Exception{
