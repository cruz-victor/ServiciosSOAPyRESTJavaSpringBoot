...
@Transactional
@Rollback 
public class testValidarArchivoIndividualP04 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarArchivoIndividualP04.class);
	...
	@Rollback(false)
	@Test
	public void validarArchivoIndividualP04() throws Exception{
