...
@Transactional
@Rollback 
public class testValidarValidacionRecepcionIndXsdP04 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarValidacionRecepcionIndXsdP04.class);
	...
	@Rollback(false)
	@Test
	public void validarValidacionRecepcionIndXsdP04() throws Exception{
