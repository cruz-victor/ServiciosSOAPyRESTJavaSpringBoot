...
@Transactional
@Rollback 
public class testValidarValidacionRecepcionPaqXsdP02 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarValidacionRecepcionPaqXsdP02.class);
	...
	@Rollback(false)
	@Test
	public void validarValidacionRecepcionPaqXsdP02() throws Exception{
