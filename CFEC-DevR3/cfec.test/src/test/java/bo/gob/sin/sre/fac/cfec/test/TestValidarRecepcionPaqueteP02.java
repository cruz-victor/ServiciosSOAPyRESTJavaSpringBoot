...
@Transactional
@Rollback 
public class TestValidarRecepcionPaqueteP02 {
	private static final Logger LOG = LoggerFactory.getLogger(TestValidarRecepcionPaqueteP02.class);
	...
	@Rollback(false)
	@Test
	public void validarRecepcionPaqueteP02() throws Exception{
		// computarizada
