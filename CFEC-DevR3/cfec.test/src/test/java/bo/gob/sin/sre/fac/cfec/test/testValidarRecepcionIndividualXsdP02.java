...
@Transactional
@Rollback 
public class testValidarRecepcionIndividualXsdP02 {
	private static final Logger LOG = LoggerFactory.getLogger(testValidarRecepcionIndividualXsdP02.class);
	...
	@Rollback(false)
	@Test
	public void validarRecepcionIndividualXsdP02() throws Exception{
