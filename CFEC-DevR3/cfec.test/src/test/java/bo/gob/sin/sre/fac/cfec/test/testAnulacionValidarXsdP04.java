...
@Transactional
@Rollback 
public class testAnulacionValidarXsdP04 {
	private static final Logger LOG = LoggerFactory.getLogger(testAnulacionValidarXsdP04.class);
	...
	@Rollback(false)
	@Test
	public void validarAnulacionXsdP04() throws Exception{
