 ...
 * 
 */
@XmlRootElement(name = "recepcionMasiva")
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",  "cuape",
		...
		"hashArchivo" })
public class XmlRecepcionMasivaPrevaloradaDto implements Serializable {
	...
	public XmlRecepcionMasivaPrevaloradaDto() {
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionMasivaPrevaloradaDto.class);
