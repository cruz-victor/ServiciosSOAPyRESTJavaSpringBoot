...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"hashArchivo" })
public class XmlRecepcionIndividualDto implements Serializable {
	...
	public XmlRecepcionIndividualDto() {
	}

	@Override
	public String toString() {
		return "XmlRecepcionFacturaDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionIndividualDto.class);
