 ...
 * 
 */
@XmlRootElement(name = "validacionRecepcionPaquete")
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		"codigoDocumentoFiscal", "codigoDocumentoSector", "codigoSucursal", "codigoPuntoVenta", "codigoRecepcion" })
public class XmlValidacionRecepcionPaqueteFacturaDto implements Serializable {
	...
	public XmlValidacionRecepcionPaqueteFacturaDto() {
	}

	@Override
	public String toString() {
		return "XmlValidacionRecepcionDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
				...
				+ ", codigoPuntoVenta=" + codigoPuntoVenta + ", codigoRecepcion=" + codigoRecepcion + "]";
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionRecepcionPaqueteFacturaDto.class);
