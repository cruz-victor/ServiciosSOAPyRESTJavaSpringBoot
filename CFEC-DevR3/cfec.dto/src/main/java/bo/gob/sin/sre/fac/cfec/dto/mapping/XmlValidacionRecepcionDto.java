...
public class XmlValidacionRecepcionDto implements Serializable {
	...
	public XmlValidacionRecepcionDto() {
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionRecepcionDto.class);
