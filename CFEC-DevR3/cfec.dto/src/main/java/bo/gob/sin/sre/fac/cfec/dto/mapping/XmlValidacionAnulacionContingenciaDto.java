...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"cuf", "codigoMotivo", "codigoRecepcion", "caed" })
public class XmlValidacionAnulacionContingenciaDto implements Serializable {
	...
	public XmlValidacionAnulacionContingenciaDto() {
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionAnulacionContingenciaDto.class);
	...
	@Override
	public String toString() {
		return "XmlValidacionAnulacionContingenciaDto [codigoSistema=" + codigoSistema + ", codigoAmbiente="
				+ codigoAmbiente + ", codigoModalidad=" + codigoModalidad + ", nit=" + nit + ", cuis=" + cuis
				+ ", cufd=" + cufd + ", codigoDocumentoFiscal=" + codigoDocumentoFiscal + ", codigoDocumentoSector="
				...
				+ ", codigoMotivo=" + codigoMotivo + ", codigoRecepcion=" + codigoRecepcion + ", caed=" + caed
