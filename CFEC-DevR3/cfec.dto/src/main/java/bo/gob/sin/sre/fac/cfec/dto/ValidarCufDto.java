...
public class ValidarCufDto {
	...
	public ValidarCufDto() {
	}
	
	public ValidarCufDto(Long pNit, Integer pSucursal, String pFecha, Integer pModalidad, Integer pTipoEmision,
			Integer pTipoDocumentoFiscal, Integer pTipoDocumentoSector, String pCuf, Long pNumFactura,
			Integer pPuntoVenta) {
		super();
		this.pNit = pNit;
	...
	public String toString() {
		return "OperacionesCuf [pNit=" + pNit + ", pSucursal=" + pSucursal + ", pFecha=" + pFecha + ", pModalidad="
				...
				+ ", pTipoDocumentoSector=" + pTipoDocumentoSector + ", pCuf=" + pCuf + ", pNumFactura=" + pNumFactura
