...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		"cuape", "codigoDocumentoFiscal", "codigoDocumentoSector", "codigoSucursal", "codigoPuntoVenta", "fechaEnvio",
		"archivo", "hashArchivo" })
public class XmlRecepcionIndividualPrevaloradaDto implements Serializable {
	...
	public XmlRecepcionIndividualPrevaloradaDto() {
	}

	@Override
	public String toString() {
		return "XmlRecepcionIndividualPrevaloradaDto [codigoSistema=" + codigoSistema + ", codigoAmbiente="
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionIndividualPrevaloradaDto.class);
