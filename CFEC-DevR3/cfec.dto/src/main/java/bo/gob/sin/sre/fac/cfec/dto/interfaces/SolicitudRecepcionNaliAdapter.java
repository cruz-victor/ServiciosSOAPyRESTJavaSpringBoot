...
public class SolicitudRecepcionNaliAdapter extends XmlAdapter<SolicitudRecepcionNali, ISolicitudRecepcionNali> {

	@Override
	public ISolicitudRecepcionNali unmarshal(SolicitudRecepcionNali mensaje) throws Exception {
		return mensaje;
	}

	@Override
	public SolicitudRecepcionNali marshal(ISolicitudRecepcionNali mensaje) throws Exception {
		if (mensaje instanceof SolicitudRecepcionNali) {
			return (SolicitudRecepcionNali) mensaje;
		}
		SolicitudRecepcionNali impl = new SolicitudRecepcionNali();
		...
		impl.setCodigoAutorizacion(mensaje.getCodigoAutorizacion());
