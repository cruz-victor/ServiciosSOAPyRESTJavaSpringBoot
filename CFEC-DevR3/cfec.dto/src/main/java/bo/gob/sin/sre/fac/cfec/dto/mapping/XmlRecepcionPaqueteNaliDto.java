...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"hashArchivo" })
public class XmlRecepcionPaqueteNaliDto implements Serializable {
	...
	public XmlRecepcionPaqueteNaliDto() {
	}

	@Override
	public String toString() {
		return "XmlRecepcionPaqueteNaliDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionPaqueteNaliDto.class);
