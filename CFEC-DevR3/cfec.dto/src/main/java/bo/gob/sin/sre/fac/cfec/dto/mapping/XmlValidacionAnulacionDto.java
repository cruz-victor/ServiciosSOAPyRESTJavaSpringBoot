...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoModalidad", "nit", "cuis", "cufd",
		"codigoDocumentoFiscal", "codigoDocumentoSector", "codigoSucursal", "codigoPuntoVenta", "numeroDocumentoFiscal",
		"cuf", "codigoMotivo", "codigoRecepcion" })
public class XmlValidacionAnulacionDto implements Serializable {
	...
	public XmlValidacionAnulacionDto() {
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionAnulacionDto.class);
			marshallerObj = contextObj.createMarshaller();
			marshallerObj.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
			marshallerObj.setProperty(Marshaller.JAXB_NO_NAMESPACE_SCHEMA_LOCATION, Parametros.ARCHIVO_XSD_VALIDACION_ANULACION);
	...
	@Override
	public String toString() {
		return "XmlValidacionAnulacionDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
				+ ", codigoModalidad=" + codigoModalidad + ", nit=" + nit + ", cuis=" + cuis + ", cufd=" + cufd
				+ ", codigoDocumentoFiscal=" + codigoDocumentoFiscal + ", codigoDocumentoSector="
				+ codigoDocumentoSector + ", codigoSucursal=" + codigoSucursal + ", codigoPuntoVenta="
				+ codigoPuntoVenta + ", numeroDocumentoFiscal=" + numeroDocumentoFiscal + ", cuf=" + cuf
				+ ", codigoMotivo=" + codigoMotivo + ", codigoRecepcion=" + codigoRecepcion + "]";
	}
