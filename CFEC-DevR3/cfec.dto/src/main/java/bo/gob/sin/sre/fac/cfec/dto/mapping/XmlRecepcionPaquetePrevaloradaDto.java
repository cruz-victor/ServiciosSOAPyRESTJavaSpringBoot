 ...
 * 
 */
@XmlRootElement(name = "recepcionPaquete")
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",  "cuape",
		"codigoDocumentoFiscal", "codigoDocumentoSector", "codigoSucursal", "codigoPuntoVenta", "fechaEnvio", "archivo",
		"hashArchivo" })
public class XmlRecepcionPaquetePrevaloradaDto implements Serializable {
	...
	public XmlRecepcionPaquetePrevaloradaDto() {
	}

	@Override
	public String toString() {
		return "XmlRecepcionPaquetePrevaloradaDto [codigoSistema=" + codigoSistema + ", codigoAmbiente="
				...
				+ codigoSucursal + ", codigoPuntoVenta=" + codigoPuntoVenta + ", fechaEnvio=" + fechaEnvio
				+ ", archivo=" + archivo + ", hashArchivo=" + hashArchivo + "]";
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionPaquetePrevaloradaDto.class);
