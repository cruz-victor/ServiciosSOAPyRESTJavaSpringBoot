...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"hashArchivo" })
public class XmlRecepcionPaqueteDto implements Serializable {
	...
	public XmlRecepcionPaqueteDto() {
	}

	@Override
	public String toString() {
		return "XmlRecepcionPaqueteFacturaDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlRecepcionPaqueteDto.class);
