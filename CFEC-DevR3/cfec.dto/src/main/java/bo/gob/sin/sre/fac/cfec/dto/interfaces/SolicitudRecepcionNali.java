...
public class SolicitudRecepcionNali implements ISolicitudRecepcionNali {
	...
	public SolicitudRecepcionNali() {

	}

	public SolicitudRecepcionNali(String codigoSistema, Integer codigoAmbiente, Integer codigoEmision,
			...
			String archivo, String hashArchivo, Long codigoAutorizacion) {
		super();
