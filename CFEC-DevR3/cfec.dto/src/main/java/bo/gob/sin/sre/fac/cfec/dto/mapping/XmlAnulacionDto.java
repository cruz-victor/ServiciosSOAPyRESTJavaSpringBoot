...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"cuf", "codigoMotivo" })
public class XmlAnulacionDto implements Serializable {
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlAnulacionDto.class);
	...
	@Override
	public String toString() {
		return "XmlRecepcionAnulacionDto [codigoSistema=" + codigoSistema + ", codigoAmbiente=" + codigoAmbiente
