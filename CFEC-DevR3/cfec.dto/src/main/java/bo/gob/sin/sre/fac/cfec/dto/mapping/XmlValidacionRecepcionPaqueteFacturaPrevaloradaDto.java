...
public class XmlValidacionRecepcionPaqueteFacturaPrevaloradaDto implements Serializable {
	...
	public XmlValidacionRecepcionPaqueteFacturaPrevaloradaDto() {
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionRecepcionPaqueteFacturaPrevaloradaDto.class);
