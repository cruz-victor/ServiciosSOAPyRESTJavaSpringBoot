...
@XmlType(propOrder = { "codigoSistema", "codigoAmbiente", "codigoEmision", "codigoModalidad", "nit", "cuis", "cufd",
		...
		"codigoRecepcion" })
public class XmlValidacionRecepcionMasivaFacturaPrevaloradaDto implements Serializable {
	...
	public XmlValidacionRecepcionMasivaFacturaPrevaloradaDto() {
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionRecepcionMasivaFacturaPrevaloradaDto.class);
