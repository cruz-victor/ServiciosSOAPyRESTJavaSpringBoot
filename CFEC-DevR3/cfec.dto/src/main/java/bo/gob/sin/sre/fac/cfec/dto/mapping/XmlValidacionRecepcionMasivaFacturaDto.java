 ...
 * 
 */
@XmlRootElement(name = "validacionRecepcionMasiva")
...
public class XmlValidacionRecepcionMasivaFacturaDto implements Serializable {
	...
	public XmlValidacionRecepcionMasivaFacturaDto() {
	}
	...
	public String obtenerFormatoXml() {
		...
		try {
			contextObj = JAXBContext.newInstance(XmlValidacionRecepcionMasivaFacturaDto.class);
